...
namespace RE
{
	enum class EXTRA_DATA_TYPE : std::int32_t
	{
		...
		Worn = 0x1B,
		WornLeft = 0x1C,
		PackageStartLocation = 0x1E,
		Package = 0x1F,
		TrespassPackage = 0x20,
		RunOncePackages = 0x21,
		ReferencePointer = 0x22,
		Follower = 0x23,
		LeveledCreatureModifier = 0x24,
		Ghost = 0x25,
		...
		AltarBigWorldLeveledRegion = 0x62,  // VExtraAltarBigWorldLeveledRegion
	};
}
